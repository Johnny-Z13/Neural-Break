...
export class MedPackManager extends PickupManager<MedPack> {
  protected readonly SPAWNS_PER_LEVEL = BALANCE_CONFIG.PICKUPS.MED_PACK.SPAWNS_PER_LEVEL
  protected readonly SPAWN_INTERVAL_MIN = BALANCE_CONFIG.PICKUPS.MED_PACK.SPAWN_INTERVAL_MIN
  protected readonly SPAWN_INTERVAL_MAX = BALANCE_CONFIG.PICKUPS.MED_PACK.SPAWN_INTERVAL_MAX
  ...
  protected shouldSpawn(timeSinceLastSpawn: number, randomInterval: number, targetSpawns: number): boolean {
    ...
    return playerHealthPercent < BALANCE_CONFIG.PICKUPS.MED_PACK.HEALTH_THRESHOLD &&
